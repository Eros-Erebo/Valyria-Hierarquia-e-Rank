document.addEventListener('DOMContentLoaded', () => {
    const membros = JSON.parse(localStorage.getItem('membros')) || [
        { nome: 'Galliard', xp: 936330, nivel: 56 },
        { nome: 'Willian Vaude', xp: 803230, nivel: 52 },
        { nome: 'Darker', xp: 544860, nivel: 43 },
        { nome: 'Feye Vaude', xp: 506900, nivel: 42 },
        { nome: 'Eöl', xp: 277470, nivel: 31 },
        { nome: 'Aysha Velarion', xp: 218700, nivel: 28 },
        { nome: 'Legolas', xp: 134900, nivel: 22 },
        { nome: 'Kota', xp: 82200, nivel: 17 },
        { nome: 'Zoro', xp: 18000, nivel: 8 },
        { nome: 'Elenion', xp: 4800, nivel: 5 },
        { nome: 'Gauriel', xp: 0, nivel: 0 },
        { nome: 'Lua', xp: 0, nivel: 0 },
        { nome: 'Alessa', xp: 0, nivel: 0 },
    ];
